...
class Quickbooks_Payments
{
 ...
 /**
	 ...
	 * @return [type]          [description]
	 */
	public function getCharge($Context, string $id)
	{
	 ...
	 * @return [type]     [description]
	 */
	public function getDebit($Context, string $id)
	{
	 ...
	 * @return QuickBooks_Payments_CreditCard
	 */
	public function getCard($Context, $id, string $card_id)
	{
		$id = str_replace(array('{', '}', '-'), '', $id);
	 ...
	 * @return boolean
	 */
	public function deleteCard($Context, $id, string $card_id)
	{
		$id = str_replace(array('{', '}', '-'), '', $id);
  ...
  return !$this->_handleError($data);
	 ...
	 * @return boolean
	 */
	protected function _handleError(array $data, $ignore_declines = false)
	{
		if ($data === [])
		{
	 ...
	 * @return boolean
	 */
	protected function _http($Context, string $url_path, $raw_body = null, $operation = null)
	{
		if ($operation !== null)
		{
			$method = $operation;
