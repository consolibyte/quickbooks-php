...
abstract class QuickBooks_Driver
{
	...
	*/
	...
	public function oauthAccessDelete($app_tenant)
	{
		return $this->_oauthAccessDelete($app_tenant);
	}

	abstract protected function _oauthAccessDelete($app_tenant);
  ...
  * @return string
  */
 final protected function _hash(string $password)
	{
	 ...
	 * @return boolean
	 */
	final protected function _callHook($hook, $ticket, &$err, array $hook_data)
	{
		$user = '';
		if ($ticket)
		{
