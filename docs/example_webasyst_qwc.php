...
/**
 * Example of generating QuickBooks *.QWC files for a WebAsyst integration
 * 
...
$name = 'QuickBooks for WebAsyst - ' . $_SERVER['HTTP_HOST'];			// A name for your server (make it whatever you want)
$descrip = 'QuickBooks for WebAsyst - ' . $_SERVER['HTTP_HOST'];		// A description of your server 
...
header('Content-Disposition: attachment; filename="QuickBooks-for-WebAsyst_' . $_SERVER['HTTP_HOST'] . '.qwc"');
print($xml);
exit;
