...
/**
 * Example of generating QuickBooks *.QWC files for a WHMCS integration
 * 
...
$name = 'QuickBooks for WHMCS - ' . $_SERVER['HTTP_HOST'];			// A name for your server (make it whatever you want)
$descrip = 'QuickBooks for WHMCS - ' . $_SERVER['HTTP_HOST'];		// A description of your server 
...
header('Content-Disposition: attachment; filename="QuickBooks-for-WHMCS_' . $_SERVER['HTTP_HOST'] . '.qwc"');
print($xml);
exit;
