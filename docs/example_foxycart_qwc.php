...
$name = 'QuickBooks for Foxycart - ' . $_SERVER['HTTP_HOST'];			// A name for your server (make it whatever you want)
$descrip = 'QuickBooks for Foxycart - ' . $_SERVER['HTTP_HOST'];		// A description of your server 
...
header('Content-Disposition: attachment; filename="QuickBooks-for-Foxycart_' . $_SERVER['HTTP_HOST'] . '.qwc"');
print($xml);
exit;
