...
// 
$dsn_or_conn = 'mysql://root:root@localhost/quickbooks_webasyst';

// 
$integrator_dsn_or_conn = 'mysql://root:root@localhost/quickbooks_webasyst';
...
// 
$Server = new QuickBooks_Server_Integrator_Webasyst(
		$dsn_or_conn, 
