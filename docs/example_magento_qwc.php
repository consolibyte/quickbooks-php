...
$name = 'QuickBooks for Magento - ' . $_SERVER['HTTP_HOST'];			// A name for your server (make it whatever you want)
$descrip = 'QuickBooks for Magento - ' . $_SERVER['HTTP_HOST'];		// A description of your server 
...
header('Content-Disposition: attachment; filename="QuickBooks-for-Magento_' . $_SERVER['HTTP_HOST'] . '.qwc"');
print($xml);
exit;
